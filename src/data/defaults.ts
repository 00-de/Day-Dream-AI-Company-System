...
export const DEFAULT_STAFF: AiStaff[] = [
  // ── コア部門 ───────────────────────────────
  { id: 'ceo', name: '玲AI', nameEn: 'Rei AI', role: 'AI社長／経営・意思決定', group: 'core', status: 'active', accent: 'cyan', tasks: 9, avatar: '/avatars/ceo.png' },
  { id: 'secretary', name: '詩織AI', nameEn: 'Shiori AI', role: 'AI秘書／スケジュール管理', group: 'core', status: 'active', accent: 'blue', tasks: 12, avatar: '/avatars/secretary.png' },
  { id: 'strategy', name: '宗一AI', nameEn: 'Soichi AI', role: 'AI戦略／戦略立案・新規事業', group: 'core', status: 'active', accent: 'purple', tasks: 6, avatar: '/avatars/strategy.png' },
  { id: 'analyst', name: '明日香AI', nameEn: 'Asuka AI', role: 'AI分析官／データ分析・レポート', group: 'core', status: 'active', accent: 'cyan', tasks: 8, avatar: '/avatars/analyst.png' },
  { id: 'sales', name: '陽太AI', nameEn: 'Yota AI', role: 'AI営業／営業支援・提案', group: 'core', status: 'active', accent: 'green', tasks: 5, avatar: '/avatars/sales.png' },
  { id: 'writer', name: '文乃AI', nameEn: 'Fumino AI', role: 'AIライター／文章作成・コピー', group: 'core', status: 'active', accent: 'pink', tasks: 7, avatar: '/avatars/writer.png' },
  { id: 'marketer', name: '舞AI', nameEn: 'Mai AI', role: 'AIマーケター／マーケティング戦略', group: 'core', status: 'active', accent: 'amber', tasks: 6, avatar: '/avatars/marketer.png' },
  { id: 'designer', name: '彩AI', nameEn: 'Aya AI', role: 'AIデザイナー／デザイン制作', group: 'core', status: 'active', accent: 'purple', tasks: 10, avatar: '/avatars/designer.png' },
  { id: 'researcher', name: '知也AI', nameEn: 'Tomoya AI', role: 'AIリサーチャー／情報収集・調査', group: 'core', status: 'active', accent: 'blue', tasks: 4, avatar: '/avatars/researcher.png' },
  { id: 'programmer', name: '拓斗AI', nameEn: 'Takuto AI', role: 'AIプログラマー／システム開発', group: 'core', status: 'active', accent: 'cyan', tasks: 14, avatar: '/avatars/programmer.png' },
  { id: 'qa', name: '澪AI', nameEn: 'Mio AI', role: 'AI品質管理／品質チェック・テスト', group: 'core', status: 'active', accent: 'green', tasks: 5, avatar: '/avatars/qa.png' },
  { id: 'security', name: '剛AI', nameEn: 'Tsuyoshi AI', role: 'AIセキュリティ／セキュリティ管理', group: 'core', status: 'active', accent: 'blue', tasks: 3, avatar: '/avatars/security.png' },
  { id: 'cloud', name: '空AI', nameEn: 'Sora AI', role: 'AIクラウド／クラウド・インフラ管理', group: 'core', status: 'active', accent: 'cyan', tasks: 4, avatar: '/avatars/cloud.png' },
  ...
  // ── 運営スタッフAI ─────────────────────────
  { id: 'takagi', name: '高木AI', nameEn: 'Takagi AI', role: '企画・プロデュース', group: 'staff', status: 'active', accent: 'cyan', tasks: 5, avatar: '/avatars/takagi.png' },
  { id: 'ota', name: '太田AI', nameEn: 'Ota AI', role: 'イベント企画・運営', group: 'staff', status: 'active', accent: 'amber', tasks: 4, avatar: '/avatars/ota.png' },
  { id: 'nakao', name: '中尾AI', nameEn: 'Nakao AI', role: '音響・サウンド管理', group: 'staff', status: 'standby', accent: 'purple', tasks: 2, avatar: '/avatars/nakao.png' },
  { id: 'shun', name: 'シュンAI', nameEn: 'Shun AI', role: '映像・配信サポート', group: 'staff', status: 'active', accent: 'blue', tasks: 6, avatar: '/avatars/shun.png' },
]
